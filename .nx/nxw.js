/**
 * Este script es un envoltorio (wrapper) para Nx que asegura que la instalación local
 * coincida con la configuración especificada en nx.json. Instala automáticamente
 * la versión requerida de Nx y de cualquier plugin en caso de que haya diferencias.
 * Después de verificar que la instalación está actualizada, ejecuta el binario de Nx.
 */
'use strict';
